...
Gerçek bir API çağrısı yapmadan, Bölüm 2'deki "hangi iş için hangi araç" karar
çerçevesini küçük bir Python kontrol listesine çevirir:
...
Güncel model/araç adları için yaşayan referans `../../docs/model-watch/` altında
tutulur. Son doğrulama: 2026-07.
...
- Kategoriler temsilîdir; model adı, fiyat, benchmark veya lisans bilgisi içermez.
  Bu tür hızla eskiyen bilgiler için `docs/model-watch/` ve resmî dokümantasyon
